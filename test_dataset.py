...
openai.api_key = "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"
hf_token = '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'
name_dataset = 'wilt'
...
generate_pipe = LLM_pipeline(llm_model="gpt-3.5-turbo", iterations=2, name_dataset=name_dataset, hf_token=hf_token)
