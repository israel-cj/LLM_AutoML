...
openai.api_key = "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"
...
clf = LLM_pipeline(llm_model="gpt-3.5-turbo", iterations=2, description_dataset=description_dataset, make_ensemble=False).fit(X_train, y_train)
